...
**Plans:**
- [x] Plan 2.1: "My Routines" Dashboard, Routine Modal Form & Schedule Management (Wave 1)
- [x] Plan 2.2: Task Builder Drawer, Dual Task Modality (Timed & Flexible), Categories & Reordering (Wave 2)
